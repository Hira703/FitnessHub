...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Send user data to backend to save in MongoDB with role
      await axiosPublic.post("/api/users", { name, email, photoURL, role: "member" });
      ...
      // Optional delay to ensure backend user is fully saved before navigation
